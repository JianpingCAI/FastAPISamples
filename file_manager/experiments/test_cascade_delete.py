...
class FileSystem(Base):
    ...
    # !!! not supported by DuckDB: ondelete="CASCADE"
    # !!! supported by SQLite: ondelete="CASCADE"
    parent_id = Column(String, ForeignKey("file_system.id", ondelete="CASCADE"), nullable=True)  # Added ondelete cascade
