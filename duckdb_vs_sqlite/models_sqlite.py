...
class TestSuite(Base):
    ...
    test_cases = relationship('TestCase', secondary=suite_case_association, back_populates='test_suites')
...
class TestCase(Base):
    ...
    test_suites = relationship('TestSuite', secondary=suite_case_association, back_populates='test_cases')
...
class Tag(Base):
    ...
    test_suites = relationship('TestSuite', secondary=test_suite_tags, back_populates='tags')
